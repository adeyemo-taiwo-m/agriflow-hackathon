...
class Settings(BaseSettings):
    ...
    INTERSWITCH_PAYMENT_CLIENT_ID: str
    INTERSWITCH_PAYMENT_SECRET_KEY: str
    INTERSWITCH_PAYMENT_MERCHANT_CODE: str
    INTERSWITCH_PAYMENT_PAY_ITEM_ID: str
    INTERSWITCH_PAYMENT_BASE_URL: str
